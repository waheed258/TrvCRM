...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title" style="font-weight: bold; color: #00AAFF">Reports</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-1 form-group text-right">
                        ...
                        <asp:ImageButton ID="imgbtnExcel" ImageUrl="~/assets/img/icon-excel.png" runat="server" Height="35px"
