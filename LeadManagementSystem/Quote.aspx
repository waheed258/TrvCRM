        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-10" style="margin-bottom: 20px; margin-top: 10px;">
                    ...
                    <asp:Button ID="imgbtnAddMultipleOptions" runat="server" Text="Add Multiple Options" CssClass="btn btn-primary" ValidationGroup="Quote" OnClick="imgbtnAddMultipleOptions_Click" OnClientClick="SetTarget1();"  />
