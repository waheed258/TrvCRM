            ...
            if (!IsPostBack)
            {
                ...
                if (flag == "1")
                {
                    ...
                    else if (QuoteType == "3")
                    {
                        ...
                        txtTravelInsur.Text = "We recommend: Travel Policy from R350.00 per person, R20 million medical cover, max 30 days. (under 69 years of age)";
                    }
                    else if (QuoteType == "1")
                    {
                        Clear();
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    MailCc = txtCC.Text;
                    string defaultConsultantEmail = Session["ConsultantEmail"].ToString();
                    ...
                    bool mailSent = UpdateCustomMail(SmtpServer, SmtpPort, MailFrom, DisplayNameFrom, FromPassword, MailTo, DisplayNameTo, MailCc, defaultConsultantEmail, "", "", DisplayNameCc, MailBcc, Subject, MailText, Attachment);
